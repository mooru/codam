...
To use these stylesheets, rename the files and codam_tech with the name of your theme.
...
codam_tech-alpha-default-narrow.css  
...
codam_tech-alpha-default-normal.css
...
codam_tech-alpha-default-wide.css
