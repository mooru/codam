...
// function arrow(){
// jQuery('.arrow').fadeIn(700, function(){
// jQuery('.arrow').fadeOut(500, function(){
// jQuery('.arrow1').fadeIn(700, function(){
//   jQuery('.arrow1').fadeOut(500, function(){
//     jQuery('.arrow2').fadeIn(700, function(){
//       jQuery('.arrow2').fadeOut(500, function(){
//         arrow();
//       });
//     });
//   });
